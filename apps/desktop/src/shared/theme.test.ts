...
const EXPECTED_CSS_VARIABLES = {
  ...
  participantName1: "--theme-participant-name1",
  participantName2: "--theme-participant-name2",
  participantName3: "--theme-participant-name3",
  participantName4: "--theme-participant-name4",
  participantName5: "--theme-participant-name5",
  participantName6: "--theme-participant-name6",
  participantName7: "--theme-participant-name7",
  participantName8: "--theme-participant-name8",
...
const CONTRAST_PAIRS: readonly ContrastPair[] = [
  ...
  { foreground: "participantName1", background: "surfaceContent", minimum: 4.5 },
  { foreground: "participantName2", background: "surfaceContent", minimum: 4.5 },
  { foreground: "participantName3", background: "surfaceContent", minimum: 4.5 },
  { foreground: "participantName4", background: "surfaceContent", minimum: 4.5 },
  { foreground: "participantName5", background: "surfaceContent", minimum: 4.5 },
  { foreground: "participantName6", background: "surfaceContent", minimum: 4.5 },
  { foreground: "participantName7", background: "surfaceContent", minimum: 4.5 },
  { foreground: "participantName8", background: "surfaceContent", minimum: 4.5 },
  { foreground: "participantName1", background: "avatarSurface", minimum: 4.5 },
  { foreground: "participantName2", background: "avatarSurface", minimum: 4.5 },
  { foreground: "participantName3", background: "avatarSurface", minimum: 4.5 },
  { foreground: "participantName4", background: "avatarSurface", minimum: 4.5 },
  { foreground: "participantName5", background: "avatarSurface", minimum: 4.5 },
  { foreground: "participantName6", background: "avatarSurface", minimum: 4.5 },
  { foreground: "participantName7", background: "avatarSurface", minimum: 4.5 },
  { foreground: "participantName8", background: "avatarSurface", minimum: 4.5 },
