  ...
  assert.deepEqual(
    selectArtifactNames(
      [
        ...
        file("hmm-chat-1.2.3-linux-arm64.AppImage"),
        file("hmm-chat-1.2.3-linux-arm64.deb"),
        file("hmm-chat-1.2.3-linux-x64.AppImage"),
        file("hmm-chat-1.2.3-linux-x64.deb"),
  ...
  assert.deepEqual(
    selectArtifactNames(
      [
        ...
        file("hmm-chat-1.2.3-linux-x64.AppImage"),
        file("hmm-chat-1.2.3-linux-x64.deb"),
        file("hmm-chat-1.2.4-linux-arm64.AppImage"),
      ],
      "1.2.3",
      "linux",
    ),
    [
      "hmm-chat-1.2.3-linux-arm64.AppImage",
      "hmm-chat-1.2.3-linux-arm64.deb",
      "hmm-chat-1.2.3-linux-x64.AppImage",
      "hmm-chat-1.2.3-linux-x64.deb",
    ],
  );
});
