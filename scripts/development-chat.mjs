 ...
 * chat mode and an access code. This code is a fixed local-only value: it never leaves the
...
export const DEVELOPMENT_SERVER_ENV = Object.freeze({
  ...
  HMM_CHAT_ACCESS_CODE: DEVELOPMENT_ACCESS_CODE,
  HMM_CHAT_DATA_PATH: path.join(repositoryRoot, ".dev-data", "hmm-chat.sqlite"),
});
